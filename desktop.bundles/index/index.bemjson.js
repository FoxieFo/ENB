module.exports = {
    ...
    content: [
        <!-- ################################################################################# -->
        { block: 'h2', tag: 'h2', 'mix': [{ block: 'font', mods: { 'weight': 'semibold', 'color': 'black' } }], content: 'Заголовки' },
        ...
        <!-- ################################################################################# -->
        { tag: 'br' },
        { block: 'h2', tag: 'h2', 'mix': [{ block: 'font', mods: { 'weight': 'semibold', 'color': 'black' } }], content: 'Кнопки' },
        { tag: 'br' },
